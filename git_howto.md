...
Для того, чтобы другие люди могли предлодить изменения в чей-либо репозиторий, используется pull request. Это команда для предложения изменений и запрос на вливание изменений в репозиторий. 
...
3. Создаем новую ветку и в нее вносим свои изменения
    ...
    Когда мы хотим внести/предложить изменения в чей-то проект, нужно всегда делать это в отдельной ветке, а которой создаем файл с нашими изменениями (обычно его называют README.md)
